        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsSubscribe = table.Column<bool>(nullable: false),
                    PersonalCode = table.Column<string>(maxLength: 10, nullable: true),
                    CreditCardNumber = table.Column<string>(maxLength: 16, nullable: true),
                    ImagePath = table.Column<string>(nullable: true),
                    SendPhoneConfirmationSmsLimitUntil = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title_En = table.Column<string>(nullable: false),
                    Title_Fa = table.Column<string>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    Code = table.Column<string>(nullable: false),
                    IndexImage = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_SubCategoryItems_CategoryId",
                        column: x => x.CategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductOptions_Warranties_WarrantyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductWeaknesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductWeaknesses_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecialReviews_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastQuantity = table.Column<int>(nullable: false),
                    Amount = table.Column<int>(nullable: false),
                    TypeOfTransaction = table.Column<byte>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_ProductOptions_OptionId",
                        column: x => x.OptionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPrices_ProductOptions_OptionId",
                        column: x => x.OptionId,
                        principalTable: "ProductOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOptions_WarrantyId",
                table: "ProductOptions",
                column: "WarrantyId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductPrices_OptionId",
                table: "ProductPrices",
                column: "OptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductWeaknesses_ProductId",
                table: "ProductWeaknesses",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecialReviews_ProductId",
                table: "SpecialReviews",
                column: "ProductId");
